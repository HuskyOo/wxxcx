...
const fontFamily = () => {
  ...
  wx.loadFontFace({
    family: '藏研黑体',
    source: "url('https://www.chonlong.cn/font/CTRC-HT.ttf')",
    success: res => {
      // console.log(res)
    }
  })
  wx.loadFontFace({
    family: 'Himalaya-G',
    source: "url('https://www.chonlong.cn/font/Himalaya-G.ttf')",
    success: res => {
      // console.log(res)
    }
  })
  wx.loadFontFace({
    family: 'Jomolhari',
    source: "url('https://www.chonlong.cn/font/Jomolhari-alpha3c-0605331.ttf')",
    success: res => {
      // console.log(res)
    }
  })
